(ns archival-curatorial.advisor
  "CuratorialAdvisor — proposes an archival-and-curatorial operation
  (catalogue an item, preserve an item, deaccession an item, release a
  restricted collection item for public access) for a registered item.
  ...
  PROPOSAL — it never writes to the store and has no notion of item
  provenance or deaccession/restricted-access risk;
  `archival-curatorial.governor` is the independent system that
  decides whether the proposal may proceed, per the itonami actor
  pattern.

  A proposal is a map:
    {:op :catalogue|:preserve|:deaccession|:release-restricted-item
...
(def ^:private system-prompt
  "You are an archival-and-curatorial advisor. Given a collection
